...
# 기존 ~/.claude/settings.json 을 덮어쓰지 않고 병합함
#
...
# ── 1. Python 확인 ──────────────────────────────────────────────────────────────
Write-Host "[1/4] Python 버전 확인..." -ForegroundColor White
$python = $null
...
# ── 2. pip 패키지 설치 ──────────────────────────────────────────────────────────
Write-Host ""
Write-Host "[2/4] 패키지 설치..." -ForegroundColor White
...
Write-Host ""
Write-Host "[3/4] 데몬 파일 배포..." -ForegroundColor White
...
Write-Host ""
Write-Host "[4/4] settings.json 훅 등록..." -ForegroundColor White
...
Write-Host "단축키: F9  (녹음 시작 / 종료 토글)" -ForegroundColor Yellow
Write-Host ""
